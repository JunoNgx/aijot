    ...
    return (
        <div className="Landing">
            ...
            <p className="Landing__MainContent">
                ...
                . Tailored for keyboard use. Thoughtful shortcuts for every task
                that matters. Handles notes, bookmarks, and todos. Organised by
                tags. Bunch of tasteful themes (
                <button
                    type="button"
                ...
                ). Offline-first and privacy-first. Optional Dropbox or GDrive
                sync. Open source and free forever.
            </p>
